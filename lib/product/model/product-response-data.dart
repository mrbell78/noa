...
List<ProductResponseData> productResponseDataFromJson(String str) => List<ProductResponseData>.from(json.decode(str).map((x) => ProductResponseData.fromJson(x)));

String productResponseDataToJson(List<ProductResponseData> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class ProductResponseData {
  ...
  factory ProductResponseData.fromJson(Map<String, dynamic> json) => ProductResponseData(
